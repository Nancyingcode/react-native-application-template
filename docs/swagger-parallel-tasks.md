...
本清单规划当前 React Native 客户端的实现和对接；T0–T11 已交付，T12 已完成客户端公共装配。最新验收和后端阻塞项见文末收尾记录；前两批记录仅为历史。现有登录、注册、Token 刷新、个人资料、商品列表/详情已有接入，保留并回归。docs/api-integration.md 的 13 接口基线已过时，不应继续据此认定缺少下单、SKU、短信等接口。
